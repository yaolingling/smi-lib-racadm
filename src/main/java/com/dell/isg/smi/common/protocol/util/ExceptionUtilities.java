 ...
 * 
 */
package com.dell.isg.smi.common.protocol.util;
...
public class ExceptionUtilities {
     ...
     */
    public static RuntimeCoreException getRuntimeCoreException(int errorID, Throwable ex, String paramName) {
    ...
    public static RuntimeCoreException getRuntimeCoreException(int errorID, Throwable ex, String paramName, String LCErrorCode, String LCErrorStr) {
     ...
     * @return Spectre Runtime Exception
     */
    public static RuntimeCoreException getRuntimeCoreException(int errorID, String paramName) {
    ...
    public static RuntimeCoreException getRuntimeCoreException(int errorID, String paramName, String LCErrorCode, String LCErrorStr) {
     ...
     * @return Spectre Runtime Exception
     */
    public static RuntimeCoreException getRuntimeCoreException(int errorID) {
     ...
     * @return Spectre Runtime Exception
     */
    public static RuntimeCoreException getRuntimeCoreException(int errorID, Throwable ex) {
     ...
     * @throws RuntimeCoreException
     */
    public static void handleRuntimeCoreException(int errorID, String... attributeValues) throws RuntimeCoreException {
        RuntimeCoreException exception = new RuntimeCoreException();
        exception.setErrorID(errorID);
     ...
     * @throws RuntimeCoreException
     */
    public static void handleRuntimeCoreException(int errorID, Throwable ex, String... attributeValues) throws RuntimeCoreException {
        RuntimeCoreException exception = new RuntimeCoreException(ex);
        exception.setErrorID(errorID);
        for (String attribute : attributeValues) {
            exception.getAttributesList().add(attribute);
     ...
     * @throws RuntimeCoreException
     */
    public static void handleRuntimeCoreException(int errorID) throws RuntimeCoreException {
        RuntimeCoreException exception = new RuntimeCoreException();
        exception.setErrorID(errorID);
        throw exception;
    }
     ...
     * @throws RuntimeCoreException
     */
    public static void handleRuntimeCoreException(int errorID, Throwable ex) throws RuntimeCoreException {
        RuntimeCoreException exception = new RuntimeCoreException(ex);
        exception.setErrorID(errorID);
        throw exception;
    }
